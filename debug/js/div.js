...
// show border
javascript: (function dfs(v, d) { Object.values(v.children).map(e => { e.style.border = `solid 1px rgba( ${(d * 25) % 255} ,0,0,${d / 10})`; dfs(e, Math.min(10, d + 1)); }); })(document.body, 0);
javascript: (function dfs(v) { Object.values(v.children).map(e => { if (e.hasChildNodes) dfs(e); e.style.background = `rgba(128,128,128,0.1)`; }); })(document.body);
// show tags
